...
export const REQUIRED_NATIVE_HOTPATH_EXPORTS = [
  ...
  "compileRouteCodexRuntimeManifestJson",
  "collectRouteCodexV2ConfigSourceErrorsJson",
  "normalizeRouteCodexV2RuntimeSourceJson",
  "resolvePrimaryRouteCodexRoutingPolicyGroupJson",
  "extractRouteCodexMaterializedProviderConfigsJson",
  "materializeRouteCodexUserConfigFromManifestJson",
  "buildRouteCodexProviderProfilesJson",
  "buildRouteCodexForwarderProfilesJson",
  ...
  "detectRouteCodexUserConfigFormatJson",
  "detectRouteCodexProviderConfigFormatJson",
  "writeRouteCodexUserConfigFileJson",
  "writeRouteCodexProviderConfigFileJson",
  "updateRouteCodexUserConfigStringScalarJson",
  "loadRouteCodexConfigJson",
  "coerceRouteCodexProviderConfigV2Json",
  "planRouteCodexProviderConfigV2FilesJson",
  "resolveRouteCodexProviderConfigV2IdentityJson",
  "loadRouteCodexProviderConfigsV2FromRootJson",
  "planAuthFileResolutionJson",
  "resolveAuthFileKeyJson",
  ...
  "planResponsesPayloadFromChatCloseoutJson",
  ...
  "sanitizeCapturedResponsesInputJson",
  "pickResponsesRequestParametersJson",
  "pickResponsesToolPassthroughFieldsJson",
  "pickResponsesBridgeDecisionMetadataJson",
  "extractResponsesMetadataExtraFieldsJson",
  "stripResponsesToolControlFieldsJson",
  "unwrapResponsesDataJson",
  "buildSlimResponsesBridgeContextJson",
  "mergeRetainedResponsesRequestParametersJson",
  ...
  "mapChatToolsToAnthropicToolsJson",
  ...
  "planResponsesConversationPersistenceEligibilityJson",
  "planResponsesConversationPreflightJson",
  "planResponsesCapturedEntryJson",
  "planResponsesPersistedEntryJson",
  "planResponsesStoreTokensJson",
  "planResponsesCapturePendingCleanupJson",
  "planResponsesRecordScopeCleanupJson",
  "planResponsesRecordScopeEntryMatchJson",
  "planResponsesRecordContinuationFlagJson",
  "planResponsesStoreSweepJson",
  "planResponsesAttachEntryScopesJson",
  "planResponsesRebindRequestIdJson",
  "planResponsesReleaseRequestPayloadJson",
  "planResponsesScopeContinuationMatchJson",
  "planResponsesConversationResumeEntryMatchJson",
  ...
  "normalizeOpenaiChatRequestJson",
  ...
  "applyToolTextRequestGuidanceJson",
    ...
    "augmentOpenAIToolsJson",
    "augmentAnthropicToolsJson",
  ...
  "planResponsesBridgePolicyActionsJson",
  ...
  "planServertoolExecutionBranchApplicationJson",
  ...
  "planServertoolResponseStageAutoHookPreApplicationJson",
  "planServertoolResponseStageAutoHookPostApplicationJson",
