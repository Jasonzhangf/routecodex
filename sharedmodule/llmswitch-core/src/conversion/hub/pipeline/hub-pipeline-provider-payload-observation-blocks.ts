...
export function unwrapRawRequestBody(rawRequest: JsonObject): Record<string, unknown> {
...
export function summarizeMessageToolHistory(messages: unknown): Record<string, unknown> {
