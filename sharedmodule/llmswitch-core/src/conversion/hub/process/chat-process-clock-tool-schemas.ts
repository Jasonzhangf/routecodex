...
const CLOCK_STANDARD_TOOLS: StandardizedTool[] = [
  ...
  },
  {
    ...
    function: {
      name: 'apply_patch',
      description: 'Apply a patch to repository files. Call with schema { patch: string }; patch must use *** Begin Patch / *** End Patch grammar with Add/Update/Delete File markers.',
      parameters: {
        type: 'object',
        properties: {
          patch: { type: 'string' }
