...
// - Adds concise, non-duplicative guidance to tool descriptions
// - Tightens parameter schemas where useful (e.g., shell command argv)
...
// Refine existing system prompt text to align tool guidance with Codex CLI conventions.
// - Appends a minimal guidance block when not already present
// - Optionally drops platform-specific shell editing tips (heredoc/sed/ed) to avoid conflicts
