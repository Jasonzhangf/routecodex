...
pub use bindings::{
    ...
    build_bridge_history_json, build_slim_responses_context_json, coerce_bridge_role_json,
    ...
    serialize_tool_arguments_json, serialize_tool_output_json, should_log_client_remap_debug_json,
