...
pub use bindings::{
    ...
    as_record_json, assert_no_unknown_tool_names_json, build_bridge_history_json,
    build_namespace_alias_json, build_namespace_lookup_key_json, build_slim_responses_context_json,
    coerce_bridge_role_json, convert_bridge_input_to_chat_messages_json,
    ensure_bridge_output_fields_json, ensure_messages_array_json, extract_client_tool_index_json,
    extract_declared_tool_names_json, extract_reasoning_segments_json,
    ...
    normalize_reasoning_in_responses_payload_json, normalize_reasoning_payload_v2_json,
    normalize_req_inbound_reasoning_payload_json, normalize_resp_inbound_reasoning_payload_json,
    prepare_responses_request_envelope_json, read_schema_json, remap_chat_tool_calls_json,
    remap_responses_tool_calls_json, repair_tool_calls_json, resolve_client_tool_from_index_json,
    resolve_responses_bridge_tools_json, resolve_responses_request_bridge_decisions_json,
    resolve_tool_family_json, run_bridge_action_pipeline_json, serialize_tool_arguments_json,
    serialize_tool_output_json, should_log_client_remap_debug_json,
    should_normalize_reasoning_payload_json, strip_function_namespace_json,
    to_canonical_tool_name_json, to_compact_tool_name_json, validate_tool_arguments_json,
};
