...
pub use bindings::{
    ...
    normalize_reasoning_in_responses_payload_json, normalize_req_inbound_reasoning_payload_json,
    normalize_resp_inbound_reasoning_payload_json, prepare_responses_request_envelope_json,
    repair_tool_calls_json, resolve_responses_bridge_tools_json,
    resolve_responses_request_bridge_decisions_json, run_bridge_action_pipeline_json, strip_function_namespace_json, to_canonical_tool_name_json, to_compact_tool_name_json, resolve_tool_family_json, build_namespace_alias_json, build_namespace_lookup_key_json, read_schema_json, should_normalize_reasoning_payload_json, normalize_reasoning_payload_v2_json, should_log_client_remap_debug_json, extract_declared_tool_names_json, assert_no_unknown_tool_names_json, extract_client_tool_index_json, resolve_client_tool_from_index_json, remap_chat_tool_calls_json, remap_responses_tool_calls_json, as_record_json, build_slim_responses_context_json,
