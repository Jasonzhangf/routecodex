...
pub use bindings::{
    ...
    normalize_reasoning_in_responses_payload_json, normalize_resp_inbound_reasoning_payload_json,
    prepare_responses_request_envelope_json, read_schema_json, remap_chat_tool_calls_json,
    repair_tool_calls_json, resolve_client_tool_from_index_json,
    ...
    serialize_tool_output_json, should_log_client_remap_debug_json, strip_function_namespace_json,
