...
struct BuildAnthropicFullInput {
    chat_response: String,
    alias_map: Option<String>,
    responses_reasoning: Option<String>,
    responses_output_text_meta: Option<String>,
    responses_payload_snapshot: Option<String>,
    responses_passthrough: Option<String>,
}

#[derive(serde::Serialize)]
struct BuildAnthropicFullOutput {
    result: String,
    id: Option<String>,
}
