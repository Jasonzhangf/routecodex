...
use followup_core::{build_followup_request_id, decide_budget_reset, inject_loop_warning, LoopWarningInput};
...
pub fn budget_reset(stop_observed: bool, stop_eligible: bool, current_used: u32) -> followup_core::BudgetResetDecision {
