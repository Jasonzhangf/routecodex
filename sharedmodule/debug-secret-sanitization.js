...
import { sanitizeString, containsSensitiveData, SECRET_PATTERNS } from './config-engine/src/utils/secret-sanitization.js';
...
const apiKeyPattern = SECRET_PATTERNS.apiKey[0]; // /sk-[a-zA-Z0-9]{48,}/g
