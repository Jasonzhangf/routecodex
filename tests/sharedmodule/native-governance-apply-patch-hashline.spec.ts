...
describe('apply_patch hashline native wiring', () => {
  beforeEach(() => {
  ...
  it('uses the single native owner for hashline-shaped payloads', () => {
  ...
  it('accepts file_path alias for hashline payloads', () => {
    const result = normalizeApplyPatchArgumentsWithNative({
      patch: '+ 2 deadbeef\nhello',
      file_path: 'note.txt',
      fileContent: 'hello'
  ...
  it('keeps nested-input fixture on hashline path', () => {
