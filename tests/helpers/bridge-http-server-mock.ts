...
export function createBridgeHttpServerMock(overrides: BridgeMock = {}): BridgeMock {
  return {
    ...
    assertDirectPassthroughResponsesSseFrameForHttp: () => undefined,
    assertDirectPassthroughResponsesSseMetadataIsolationForHttp: () => undefined,
    ...
    buildResponsesStreamIncompleteErrorPayloadForHttp: () => ({ error: { message: 'stream incomplete' } }),
    ...
    isDirectPassthroughTransportKeepaliveFrameForHttp: () => false,
    ...
    normalizeResponsesSseFrameForClientForHttp: (payload: unknown) => payload,
    planResponsesContinuationCloseActionForHttp: () => ({ action: 'none' }),
    planResponsesStreamEndRepairForHttp: () => ({ action: 'none' }),
    ...
    projectResponsesSseFrameForClientForHttp: (payload: unknown) => payload,
    ...
    resolveResponsesProviderProtocolHintFromSseFrameForHttp: () => undefined,
