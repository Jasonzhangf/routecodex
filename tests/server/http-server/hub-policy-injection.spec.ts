...
describe('RouteCodexHttpServer hub policy injection', () => {
  ...
  it('injects hubConfig.policy when ROUTECODEX_HUB_POLICY_MODE=observe', async () => {
    ...
    jest.unstable_mockModule(BRIDGE_MODULE_PATH, () => ({
      ...
      loadHeartbeatStateSnapshot: async () => null,
      listHeartbeatStatesSnapshot: async () => [],
      listHeartbeatHistorySnapshot: async () => [],
      appendHeartbeatHistoryEventSnapshot: async () => {},
      setHeartbeatEnabledSnapshot: async () => false,
      runHeartbeatDaemonTickSnapshot: async () => false,
      setClockRuntimeHooksSnapshot: async () => true,
      buildHeartbeatInjectTextSnapshot: async () => '',
      resolveHeartbeatConfigSnapshot: async () => null,
      startClockDaemonIfNeededSnapshot: async () => false,
      setHeartbeatRuntimeHooksSnapshot: async () => true,
      startHeartbeatDaemonIfNeededSnapshot: async () => false,
