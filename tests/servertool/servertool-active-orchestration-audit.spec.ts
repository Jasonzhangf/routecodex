...
const DELETED_FILES = [
  ...
  'tests/servertool/entry-preflight-shell.spec.ts',
  'tests/servertool/entry-context-shell.spec.ts',
  'tests/servertool/response-stage-finalize-shell.spec.ts',
...
const TARGETS = [
  ...
  },
  {
    ...
    forbidden: [
      ...
      'result: { mode: entryPreflightPlan.resultMode, finalChatResponse: options.chatResponse }',
      'entryPreflightPlan.resultMode',
      "result: { mode: 'passthrough', finalChatResponse: options.chatResponse }",
  ...
  },
  {
    file: 'sharedmodule/llmswitch-core/src/servertool/execution-stage-shell.ts',
    forbidden: [
      "from './dispatch-preparation-shell.js'",
      ...
      "from './response-stage-finalize-shell.js'",
    ],
    required: [
      'readRuntimeMetadataSnapshotFromAnyBoundMetadataCenter',
