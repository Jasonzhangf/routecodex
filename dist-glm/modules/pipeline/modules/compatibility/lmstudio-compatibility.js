...
export class LMStudioCompatibility {
    constructor(config, dependencies) {
        ...
        this.type = 'lmstudio-compatibility';
    ...
    async processIncoming(request) {
        ...
        try {
            ...
            const transformedResult = await this.applyTransformations(request, this.getRequestTransformationRules());
    ...
    async processOutgoing(response) {
        ...
        try {
            ...
            const transformedResult = await this.applyTransformations(response, this.getResponseTransformationRules());
            // Extract the actual transformed data from the result
     ...
     */
    getResponseTransformationRules() {
        const moduleConfig = this.config.config;
        const rules = [...this.rules];
