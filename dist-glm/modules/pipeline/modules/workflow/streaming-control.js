 ...
 */
export class StreamingControlWorkflow {
    constructor(config, dependencies) {
        this.dependencies = dependencies;
        this.type = 'streaming-control';
        this.workflowType = 'streaming-converter';
     ...
     */
    async processStreamingControl(request) {
     ...
     */
    convertStreamingToNonStreaming(request) {
        const converted = {
            ...request,
     ...
     */
    extractStreamingMetadata(request) {
        return {
