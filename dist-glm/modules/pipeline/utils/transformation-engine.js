...
export class TransformationEngine {
     ...
     */
    async transform(data, rules, context) {
     ...
     */
    async applyRule(data, rule, context) {
        const startTime = Date.now();
        try {
            let result = data;
     ...
     */
    async applyMappingRule(data, rule, context) {
     ...
     */
    async applyRenameRule(data, rule, context) {
        const sourceValue = JSONPathUtils.getValue(data, rule.sourcePath || '');
     ...
     */
    async applyValueRule(data, rule, context) {
     ...
     */
    async applyExtractRule(data, rule, context) {
        const sourceValue = JSONPathUtils.getValue(data, rule.sourcePath || '');
     ...
     */
    async applyCombineRule(data, rule, context) {
     ...
     */
    async applyConditionalRule(data, rule, context) {
        ...
        const targetRule = conditionMet ? rule.thenRule : rule.elseRule;
        if (targetRule) {
     ...
     */
    generateTransformationId(data, rules) {
 ...
 */
export function createTransformationEngine(config) {
