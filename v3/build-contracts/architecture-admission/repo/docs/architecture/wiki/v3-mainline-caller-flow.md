...
flowchart TD
  ...
  module_v3_runtime__hub_v1 -->|1 edges / 1 paths| module_provider_compat_core
...
| v3-runtime::hub_v1 | provider-compat-core | 1 | `v3.selected_provider_model_binding` |
...
flowchart TD
  subgraph c_25_v3_responses_websocket_v2_transport_hardening_m_v3_provider_responses["v3-provider-responses"]
    ...
    c_25_v3_responses_websocket_v2_transport_hardening_2["v3-provider-responses<br/>websocket_sse_stream<br/><small>routecodex-v3-provider-responses/src/transport/websocket.rs</small>"]
  end
...
```mermaid
flowchart TD
  subgraph c_45_v3_selected_provider_model_binding_m_provider_compat_core["provider-compat-core"]
    c_45_v3_selected_provider_model_binding_5["provider-compat-core<br/>run_req_outbound_stage3_compat<br/><small>provider-compat-core/src/lib.rs</small>"]
  end
