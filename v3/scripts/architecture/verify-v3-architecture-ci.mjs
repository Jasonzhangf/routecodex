...
const STEPS = [
  ...
  ['test:v3-stopless-state-machine-docs-red-fixtures', 'Stopless state-machine documentation mutations are rejected'],
  ['verify:v3-normalization-payload-logic-boundary', 'V3 normalization payload/logic boundary'],
  ['test:v3-normalization-payload-logic-boundary-red-fixtures', 'Normalization boundary mutations are rejected'],
  ['verify:v3-hub-relay-runtime-closeout', 'V3 hub relay runtime closeout'],
  ['test:v3-hub-relay-runtime-closeout-red-fixtures', 'Hub Relay closeout mutations are rejected'],
  ...
  ['test:v3-hub-pipeline-core-manifest-red-fixtures', 'Hub pipeline manifest mutations are rejected'],
];
