...
function validatePackageScripts(doc) {
  ...
  requireValue(scripts['verify:v3-stopless-state-machine-docs'] === 'node scripts/run-admission-gate.mjs scripts/architecture/verify-v3-stopless-state-machine-docs.mjs', 'package.json: verify:v3-stopless-state-machine-docs script mismatch');
