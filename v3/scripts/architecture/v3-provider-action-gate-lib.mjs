...
const requiredV3Edges = [
  ...
  },
  {
    ...
    from_node: 'V3Error05RecoveryWitness',
    to_node: 'V3ProviderActionGateAdmission',
    caller_symbol: 'execute_v3_responses_direct_runtime_kernel_core_with_handoff_budget',
  ...
  },
  {
    ...
    callee_file: files.policy,
    call_witness: /\b(?:health|provider_health)\s*\.\s*record_post_commit_provider_stream_failure_from_source\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
