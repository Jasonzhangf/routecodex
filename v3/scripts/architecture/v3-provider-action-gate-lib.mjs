...
const requiredV3Edges = [
  ...
  },
  {
    ...
    from_node: 'V3Error05RecoveryWitness',
    to_node: 'V3ProviderActionGateAdmission',
    caller_symbol: 'execute_v3_responses_direct_runtime_kernel_core_resident',
  ...
  },
  {
    ...
    caller_symbol: 'execute_v3_responses_direct_runtime_kernel_core_resident',
    caller_file: files.direct,
    callee_symbol: 'record_v3_direct_provider_success',
    callee_file: files.directHelpers,
    call_witness: /\brecord_v3_direct_provider_success\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
    ...
    caller_symbol: 'record_v3_direct_provider_success',
    caller_file: files.directHelpers,
  ...
  },
  {
    ...
    from_node: 'V3ProviderActionFailureObserved',
    to_node: 'V3ProviderActionFailureRecorded',
    caller_symbol: 'run_v3_direct_provider_failure_policy',
    caller_file: files.directHelpers,
    callee_symbol: 'record_v3_direct_provider_failure_record',
    callee_file: files.directHelpers,
    call_witness: /\brecord_v3_direct_provider_failure_record\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
  ...
  },
  {
    ...
    call_witness: /\brecord_provider_success_after_response_governance\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
    ...
    to_node: 'V3ProviderActionSuccessRecorded',
    caller_symbol: 'record_provider_success_after_response_governance',
    caller_file: files.anthropic,
    callee_symbol: 'V3ProviderFailureRuntimeHealth::record_provider_success_in_failure_scope',
    callee_file: files.policy,
    call_witness: /\bprovider_health\s*\.\s*record_provider_success_in_failure_scope\s*\(/u,
  ...
  },
  {
    ...
    caller_symbol: 'record_direct_sse_provider_event_json_chunk',
    caller_file: files.directSse,
    callee_symbol: 'classify_v3_provider_sse_json_data',
    callee_file: files.providerSseJsonCodec,
    call_witness: /\bclassify_v3_provider_sse_json_data\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
    ...
    caller_symbol: 'record_direct_sse_provider_event_json_chunk',
    caller_file: files.directSse,
    callee_symbol: 'process_sse_object_frame',
    callee_file: 'v3/crates/routecodex-v3-runtime/src/sse_object_pipeline.rs',
    call_witness: /\bprocess_sse_object_frame\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
    ...
    callee_symbol: 'observe_v3_runtime_responses_sse_transport_chunk_typed',
    callee_file: files.responsesCodec,
    call_witness: /\bobserve_v3_runtime_responses_sse_transport_chunk_typed\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
  {
    ...
    from_node: 'V3ProviderResponsesEventCodec',
    to_node: 'V3ProviderResponsesTerminalOrFailureObserved',
    caller_symbol: 'apply_v3_typed_responses_event',
    caller_file: files.responsesCodec,
    callee_symbol: 'V3ResponsesSseReducerState::apply_event',
    callee_file: 'v3/crates/routecodex-v3-runtime/src/hub_v1/responses_sse_tree.rs',
    call_witness: /\breducer\.apply_event\s*\(/u,
    status: 'anchored',
    owner_feature_id: 'v3.provider_action_gate',
  },
];
