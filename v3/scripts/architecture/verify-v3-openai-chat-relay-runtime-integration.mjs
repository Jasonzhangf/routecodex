...
const relayCore = readFileSync(relayCorePath, 'utf8');
const relayShared = readFileSync(relaySharedPath, 'utf8');
...
const openaiServer = serverExecutors.slice(
  serverExecutors.indexOf('fn openai_chat_relay_output_response'),
  serverExecutors.indexOf('fn anthropic_relay_output_response'),
);
const failures = [];
