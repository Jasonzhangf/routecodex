...
const fixtures = [
  [
    ...
    'removed_v3_anthropic_relay_runtime_req_inbound',
    /missing run_v3_anthropic_relay_runtime_req_inbound/,
  ],
  [
    'client projection static callback removed',
    source,
    'run_v3_anthropic_relay_client_projection_hook',
    'removed_v3_anthropic_relay_client_projection_hook',
    /missing run_v3_anthropic_relay_client_projection_hook/,
  ],
  [
