...
const cases = [
  ...
  ['Server Gemini semantic parse', server, 'pub(crate) fn gemini_relay_output_response(\n    output: V3GeminiRelayRuntimeOutput,\n    stream_console_finalizer: Option<V3SseConsoleFinalizer>,\n) -> Response<Body> {\n    let content_type = match &output.client_body {', 'pub(crate) fn gemini_relay_output_response(\n    output: V3GeminiRelayRuntimeOutput,\n    stream_console_finalizer: Option<V3SseConsoleFinalizer>,\n) -> Response<Body> {\n    let _semantic_parse = "finishReason";\n    let content_type = match &output.client_body {', /finishReason/],
