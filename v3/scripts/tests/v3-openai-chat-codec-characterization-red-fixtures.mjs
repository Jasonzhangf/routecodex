...
const fixtures = [
  ...
  ['side channel', 'v3/crates/routecodex-v3-runtime/src/hub_v1/openai_chat_codec.rs', 'V3_ROUTECODEX_CONTROL_PAYLOAD_KEYS', 'V3_REMOVED_CONTROL_PAYLOAD_KEYS', /missing V3_ROUTECODEX_CONTROL_PAYLOAD_KEYS/],
