...
const cases = [
  ...
  },
  {
    ...
    mutate: (source) => source.replace('"verify:v3-architecture-docs": "npm run verify:v3-provider-directory-config && ', '"verify:v3-architecture-docs": "'),
    diagnostic: /verify:v3-architecture-docs must run npm run verify:v3-provider-directory-config/u,
  },
];
