...
const fixtures = [
  ...
  ['temperature collapse to top p', 'v3/crates/routecodex-v3-runtime/src/hub_v1/gemini_codec.rs', '"request.generationConfig.temperature",\n        V3GeminiChatGenerationConfigScalarSemantic::ChatTemperature,', '"request.generationConfig.temperature",\n        V3GeminiChatGenerationConfigScalarSemantic::ChatTopP,', /temperature.*must map near ChatTemperature/],
  ['top p collapse to top k', 'v3/crates/routecodex-v3-runtime/src/hub_v1/gemini_codec.rs', '"request.generationConfig.topP",\n        V3GeminiChatGenerationConfigScalarSemantic::ChatTopP,', '"request.generationConfig.topP",\n        V3GeminiChatGenerationConfigScalarSemantic::ChatTopK,', /topP.*must map near ChatTopP|topP.*must not collapse near ChatTopK/],
  ['max output collapse to reasoning budget', 'v3/crates/routecodex-v3-runtime/src/hub_v1/gemini_codec.rs', '"request.generationConfig.maxOutputTokens",\n        V3GeminiChatGenerationConfigScalarSemantic::ChatMaxCompletionTokens,', '"request.generationConfig.maxOutputTokens",\n        V3GeminiChatGenerationConfigScalarSemantic::ChatReasoningBudgetTokens,', /maxOutputTokens.*must map near ChatMaxCompletionTokens|maxOutputTokens.*must not collapse near ChatReasoningBudgetTokens/],
  ...
  ['generation scalar required test', 'v3/crates/routecodex-v3-runtime/tests/hub_gemini_codec_characterization.rs', 'gemini_generation_config_temperature_maps_to_chat_temperature', 'gemini_generation_config_temperature_removed', /missing gemini_generation_config_temperature_maps_to_chat_temperature/],
];
const failures = [];
