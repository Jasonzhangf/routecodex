...
const cases = [
  ...
  {
    name: 'Responses inbound drops registered tool-result status carrier writer',
    file: 'v3/crates/routecodex-v3-runtime/src/hub_v1/responses_openai_codec.rs',
    from: '"responses_tool_output_status".to_string(),',
    to: '"responses_tool_output_status_removed".to_string(),',
    diagnostic: /responses_tool_output_status|responses_openai_codec/u,
  },
  {
    name: 'Anthropic outbound drops registered tool-result status carrier reader',
    file: 'v3/crates/routecodex-v3-runtime/src/hub_v1/anthropic_codec/responses_to_anthropic.rs',
    from: 'extension.get("responses_tool_output_status")',
    to: 'extension.get("responses_tool_output_status_removed")',
    diagnostic: /responses_tool_output_status|responses_to_anthropic/u,
  },
  {
    name: 'Responses to Chat tool-result status carrier whitebox is removed',
    file: 'v3/crates/routecodex-v3-runtime/src/hub_v1/responses_openai_codec_extra_tests.rs',
    from: 'responses_tool_result_status_survives_chat_canonical_carrier',
    to: 'responses_tool_result_status_carrier_whitebox_removed',
    diagnostic: /responses_tool_result_status_survives_chat_canonical_carrier/u,
  },
  {
    name: 'Responses to Anthropic full Relay tool-result error regression is removed',
    file: 'v3/crates/routecodex-v3-runtime/tests/responses_relay_anthropic_provider_wire_integration.rs',
    from: 'responses_relay_anthropic_wire_preserves_typed_tool_result_error_status',
    to: 'responses_relay_anthropic_tool_result_error_regression_removed',
