...
const cases = [
  {
    ...
    marker: 'pub fn build_v3_provider_12_responses_wire_payload',
    mutation:
  ...
  },
  {
    ...
    file: 'package.json',
    marker: '    "verify:v3-relay-tool-servertool-multiturn-parity-closeout": "node v3/scripts/architecture/verify-v3-relay-tool-servertool-multiturn-parity.mjs",\n',
    mutation: '',
