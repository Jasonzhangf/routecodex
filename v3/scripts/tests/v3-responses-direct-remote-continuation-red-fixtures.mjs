...
const cases = [
  ...
  ['WebSocket SSE materialization', 'v3/crates/routecodex-v3-provider-responses/src/transport/websocket.rs', 'fn websocket_sse_stream(', 'fn materialized() { let mut sse_frames = Vec::new(); sse_frames.push(Vec::<u8>::new()); }\nfn websocket_sse_stream(', /sse_frames/],
