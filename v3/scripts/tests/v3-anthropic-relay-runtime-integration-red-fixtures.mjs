...
for (const [name, relative, from, to, diagnostic] of cases) {
  ...
  try {
    ...
    cpSync(
      resolve(repo, 'v3/crates/routecodex-v3-server/src/lib.rs'),
      resolve(root, 'v3/crates/routecodex-v3-server/src/lib.rs'),
    );
