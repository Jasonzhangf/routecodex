...
pub fn build_v3_execution_11_protocol_decision_from_v3_target_10(
    ...
    // provider.responses.process is provider-private truth. It never overrides
    // the entry's protocol execution mode: a responses entry that selects a
    // responses-native provider stays SameProtocolDirect.
