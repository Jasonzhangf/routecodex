...
pub fn apply_v3_responses_sse_semantic_hook(
    ...
    apply_v3_responses_sse_semantic_hook_with_observation(semantic, transport, protocol, hook, None)
}
...
#[path = "responses_sse_tree_projection.rs"]
mod responses_sse_tree_projection;
pub use responses_sse_tree_projection::*;
