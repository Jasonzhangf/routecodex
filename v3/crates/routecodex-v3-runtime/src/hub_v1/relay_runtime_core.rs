...
mod tests {
    ...
    async fn guard_rejects_empty_sse_stream() {
        ...
        let result = guard_relay_sse_first_frame("req-empty", "provider-1", stream, Some(30_000)).await;
    ...
    async fn guard_propagates_first_frame_provider_error() {
        ...
        let result = guard_relay_sse_first_frame("req-err", "provider-1", stream, Some(30_000)).await;
