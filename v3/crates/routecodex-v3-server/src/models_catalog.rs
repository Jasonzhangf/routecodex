// V3 models catalog projection shell.
// Builds client-facing /v1/models catalog metadata only; no routing/runtime policy.

use super::*;

pub(super) fn build_v3_models_catalog(
...
pub(super) fn is_v3_hidden_codex_future_model(model_id: &str) -> bool {
    let trimmed = model_id.trim();
    trimmed == "gpt-5.6" || trimmed.starts_with("gpt-5.6-")
}

pub(super) struct V3ModelCapabilityProjection {
...
pub(super) fn default_builtin_v3_model_capabilities(model_id: &str) -> BTreeSet<String> {
...
pub(super) fn build_v3_model_capability_projection(
...
pub(super) fn build_v3_codex_model_metadata(
    visible_id: &str,
