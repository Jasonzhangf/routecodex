// V3 request-id allocation: persistent per-day counter state, clock/format
// helpers, and the request-id token normalization used by the Server console.
// Debug/observability side-channel only — never enters business payloads.
