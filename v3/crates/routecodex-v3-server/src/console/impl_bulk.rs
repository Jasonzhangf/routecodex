...
fn v3_webui_terminal_event_for_response(
    status: u16,
    observability: &V3RuntimeObservability,
) -> V3ObsEventType {
...
pub(crate) fn resolve_v3_console_route_projection(
    ...
    eprintln!(
        "[RouteCodexV3] console observability missing pool_id/routing_group_id; projecting route:missing"
    );
    V3ConsoleRouteProjection {
        label: "-".to_string(),
        reason: "route:missing".to_string(),
    }
}
