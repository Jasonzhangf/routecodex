...
import {
  ...
  verifyV3DebugBudget,
} from '../../scripts/run-v3-cargo-test.mjs';
...
const mutations = [
  ...
  },
  {
    ...
    sources: {
      ...sources,
      packageJson: sources.packageJson.replace('node scripts/run-v3-cargo-test.mjs', 'cargo test -p routecodex-v3-runtime'),
    },
  },
  {
