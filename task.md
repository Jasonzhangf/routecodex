...
- **最新验证（2026-01-27）**：`node scripts/run-ci-coverage.mjs`
  - lines **68.63%** / branches **53.16%** / functions **72.09%** / statements **68.63%**
...
- **当前覆盖率基线（本地，2026-01-27）**：`src/**` ≈ lines **68.48%** / branches **53.01%** / functions **71.89%** / statements **68.48%**；CI 临时 gate（min）= **48**（未达 90%，持续抬升）
