...
| **Process Stage (host)** | RouteCodex workflow 对 canonical JSON 做路由、兼容 patch；写入 `providerId/providerProtocol/processMode/stream`。| 现有虚拟路由器 + `src/modules/pipeline/modules/compatibility/*` |
