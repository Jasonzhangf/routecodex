...
| `routecodex-v3-runtime` | lifecycle executor, resource graph, adjacent node transitions, static hook registry | config file IO, route/target/error semantic ownership, env secret read, raw provider transport IO, HTTP listener |
