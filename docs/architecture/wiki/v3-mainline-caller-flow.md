...
flowchart TD
  subgraph c_34_v3_protocol_conversion_field_parity_m_v3_runtime["v3-runtime"]
    ...
    c_34_v3_protocol_conversion_field_parity_8["v3-runtime<br/>responses_relay_reasoning_effort_projects_minimax_adaptive_thinking<br/><small>routecodex-v3-runtime/tests/responses_relay_anthropic_provider_wire_integration.rs</small>"]
