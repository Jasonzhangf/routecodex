...
Generated view: 59 functional paths, 379 caller edges.
...
flowchart TD
  ...
  module_v3_runtime -->|4 edges / 4 paths| module_routecodex_v3_route_classifier
  ...
  module_v3_runtime -->|5 edges / 3 paths| module_v3_virtual_router
...
| v3-runtime | routecodex-v3-route-classifier | 4 | `v3.compaction_request_routing`<br/>`v3.route_classifier.facts_classification`<br/>`v3.web_search_servertool_state_machine`<br/>`vr.current_turn_typed_route_facts` |
...
| v3-runtime | v3-virtual-router | 5 | `v3.compaction_request_routing`<br/>`v3.responses_direct.required_mainline`<br/>`v3.web_search_servertool_state_machine` |
