...
Generated view: 39 functional paths, 255 caller edges.
...
flowchart TD
  ...
  module_v3_runtime__hub_v1 -->|101 edges / 13 paths| module_v3_runtime__hub_v1
...
| v3-runtime::hub_v1 | v3-runtime::hub_v1 | 101 | `v3.anthropic_relay.controlled_runtime`<br/>`v3.anthropic_relay.local_continuation`<br/>`v3.gemini_relay.controlled_runtime`<br/>`v3.hub_pipeline.v1.relay_request_source_slice`<br/>`v3.hub_pipeline.v1.relay_response_source_slice`<br/>`v3.hub_pipeline.v1.request`<br/>`v3.hub_pipeline.v1.response`<br/>`v3.hub_relay.runtime_closeout`<br/>`v3.openai_chat.provider_event_codec`<br/>`v3.openai_chat_relay.controlled_runtime`<br/>`v3.protocol_normalization_tool_governance_boundary`<br/>`v3.resp03_tool_governance_gap_closeout`<br/>`v3.servertool_hook_skeleton_lifecycle` |
...
## v3.openai_chat.provider_event_codec

OpenAI Chat SSE decoding inside the existing Resp01-to-ProviderRespCompat02 edge preserves provider tool-call identity when one wire index is reused; it introduces no new pipeline node or response exit.

Owner feature: `v3.hub_relay_runtime_closeout`

```mermaid
flowchart TD
  subgraph c_27_v3_openai_chat_provider_event_codec_m_v3_runtime__hub_v1["v3-runtime::hub_v1"]
    c_27_v3_openai_chat_provider_event_codec_0["v3-runtime::hub_v1<br/>build_v3_hub_resp_inbound_02_from_provider_stream_events_for_protocol<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small>"]
    c_27_v3_openai_chat_provider_event_codec_1["v3-runtime::hub_v1<br/>build_v3_hub_resp_inbound_02_from_openai_chat_provider_stream_events<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small>"]
    c_27_v3_openai_chat_provider_event_codec_2["v3-runtime::hub_v1<br/>collect_openai_chat_stream_event<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small>"]
    c_27_v3_openai_chat_provider_event_codec_3["v3-runtime::hub_v1<br/>collect_openai_chat_stream_tool_call_deltas<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small>"]
  end
  c_27_v3_openai_chat_provider_event_codec_0 -->|v3-openai-chat-event-codec-01<br/>V3ProviderRespInbound01Raw → ProviderRespCompat02ProviderCompat| c_27_v3_openai_chat_provider_event_codec_1
  c_27_v3_openai_chat_provider_event_codec_2 -->|v3-openai-chat-event-codec-02<br/>V3ProviderRespInbound01Raw → ProviderRespCompat02ProviderCompat| c_27_v3_openai_chat_provider_event_codec_3
```

| Step | Node edge | Status | Caller | Callee | Owner |
| --- | --- | --- | --- | --- | --- |
| `v3-openai-chat-event-codec-01` | `V3ProviderRespInbound01Raw` → `ProviderRespCompat02ProviderCompat` | anchored | build_v3_hub_resp_inbound_02_from_provider_stream_events_for_protocol<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small> | build_v3_hub_resp_inbound_02_from_openai_chat_provider_stream_events<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small> | `v3.hub_relay_runtime_closeout` |
| `v3-openai-chat-event-codec-02` | `V3ProviderRespInbound01Raw` → `ProviderRespCompat02ProviderCompat` | anchored | collect_openai_chat_stream_event<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small> | collect_openai_chat_stream_tool_call_deltas<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small> | `v3.hub_relay_runtime_closeout` |
...
flowchart TD
  subgraph c_29_v3_protocol_conversion_field_parity_m_v3_runtime["v3-runtime"]
    ...
    c_29_v3_protocol_conversion_field_parity_2["v3-runtime<br/>responses_openai_chat_field_parity_response_matrix<br/><small>routecodex-v3-runtime/tests/responses_relay_local_continuation_integration.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_4["v3-runtime<br/>responses_relay_reasoning_request_config_projects_anthropic_system_marker<br/><small>routecodex-v3-runtime/tests/responses_relay_anthropic_provider_wire_integration.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_6["v3-runtime<br/>anthropic_responses_field_parity_request_matrix<br/><small>routecodex-v3-runtime/tests/anthropic_relay_runtime_integration.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_8["v3-runtime<br/>anthropic_responses_field_parity_response_matrix<br/><small>routecodex-v3-runtime/tests/anthropic_relay_runtime_integration.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_10["v3-runtime<br/>openai_chat_same_protocol_field_parity_request_response_matrix<br/><small>routecodex-v3-runtime/tests/openai_chat_relay_runtime_integration.rs</small>"]
  end
  subgraph c_29_v3_protocol_conversion_field_parity_m_v3_runtime__hub_v1["v3-runtime::hub_v1"]
    ...
    c_29_v3_protocol_conversion_field_parity_3["v3-runtime::hub_v1<br/>build_v3_responses_provider_response_from_openai_chat_payload<br/><small>routecodex-v3-runtime/src/hub_v1/responses_relay_runtime.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_5["v3-runtime::hub_v1<br/>build_provider_req_compat_06_from_v3_hub_req_outbound_07<br/><small>routecodex-v3-runtime/src/hub_v1/provider_req_compat_06_provider_compat.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_7["v3-runtime::hub_v1<br/>encode_v3_anthropic_request_as_responses_semantic<br/><small>routecodex-v3-runtime/src/hub_v1/anthropic_codec.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_9["v3-runtime::hub_v1<br/>project_v3_responses_json_as_anthropic_message<br/><small>routecodex-v3-runtime/src/hub_v1/anthropic_relay_runtime_codec.rs</small>"]
    c_29_v3_protocol_conversion_field_parity_11["v3-runtime::hub_v1<br/>execute_v3_openai_chat_relay_runtime<br/><small>routecodex-v3-runtime/src/hub_v1/openai_chat_relay_runtime.rs</small>"]
  end
  ...
  c_29_v3_protocol_conversion_field_parity_2 -->|v3-protocol-field-parity-responses-chat-resp-01<br/>V3ProviderRespInbound01Raw → V3HubRespInbound02Normalized| c_29_v3_protocol_conversion_field_parity_3
  c_29_v3_protocol_conversion_field_parity_4 -->|v3-protocol-field-parity-responses-anthropic-req-01<br/>V3HubReqOutbound07ProviderSemantic → ProviderReqCompat06ProviderCompat| c_29_v3_protocol_conversion_field_parity_5
  c_29_v3_protocol_conversion_field_parity_6 -->|v3-protocol-field-parity-anthropic-responses-req-01<br/>V3HubReqInbound02Normalized → V3HubReqOutbound07ProviderSemantic| c_29_v3_protocol_conversion_field_parity_7
  c_29_v3_protocol_conversion_field_parity_8 -->|v3-protocol-field-parity-responses-anthropic-resp-01<br/>V3HubRespOutbound05ClientSemantic → V3ServerRespOutbound06ClientFrame| c_29_v3_protocol_conversion_field_parity_9
  c_29_v3_protocol_conversion_field_parity_10 -->|v3-protocol-field-parity-openai-chat-same-protocol-01<br/>V3OpenAiChatRelayRuntimeInput → V3ServerRespOutbound06ClientFrame| c_29_v3_protocol_conversion_field_parity_11
```
...
flowchart TD
  subgraph c_38_v3_selected_provider_model_binding_m_llmswitch_core["llmswitch-core"]
    c_38_v3_selected_provider_model_binding_5["llmswitch-core<br/>run_req_outbound_stage3_compat<br/><small>llmswitch-core/rust-core/crates/provider-compat-core/src/req_outbound_stage3_compat.rs</small>"]
  end
