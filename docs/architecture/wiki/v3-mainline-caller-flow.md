...
Generated view: 75 functional paths, 438 caller edges.
...
flowchart TD
  ...
  module_v3_runtime -->|62 edges / 18 paths| module_v3_runtime
...
flowchart TD
  ...
  c_74_v3_execution_control_payload_architecture_0 -->|v3-direct-sse-full-attempt-terminal-commit<br/>V3DirectResp14ProviderProjectionPrepared → V3DirectSseAccept03ProjectedClientFrame| c_74_v3_execution_control_payload_architecture_3
```
