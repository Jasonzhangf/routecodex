...
- 2026-06-08 correction: `empty_reply_continue` is not part of the servertool followup runtime-action/runtime-metadata commit. The unverified Rust/NAPI/TS half-chain must stay out of this slice; do not add `servertool-core::empty_reply_continue_contract`, `planEmptyReply*` native exports, or a TS handler unless the full feature is implemented and verified as a separate Rust-owned contract.
