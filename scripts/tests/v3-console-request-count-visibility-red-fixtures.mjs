...
const cases = [
  {
    ...
    mutate: (source) =>
      source.replace("    daily_count: u64,", "    daily_count_removed: u64,"),
  ...
  {
    name: "CI skips request count red fixtures",
    path: ".github/workflows/test.yml",
    mutate: (source) =>
      source.replaceAll(
        "        run: npm run test:v3-console-request-count-visibility-red-fixtures\n",
        "",
      ),
    diagnostic: /CI must run the request count red fixtures/u,
  },
];
