...
const cases = [
  ...
  ['restart skill broadens generator exception to semantic rewriting', '.agents/skills/rcc-server-restart/SKILL.md', '绝不能用于语义改写', '也可用于语义改写'],
  ...
  ['restart entry loses transport compensation ban', '.agents/skills/rcc-server-restart/SKILL.md', 'handler/SSE/outbound 补偿', 'transport cleanup'],
