...
if (failures.length) {
  console.error('[test:v3-anthropic-codec-characterization-red-fixtures] failed');
  for (const failure of failures) console.error('- ' + failure);
  process.exit(1);
}
console.log('[test:v3-anthropic-codec-characterization-red-fixtures] ok (' + fixtures.length + ' forbidden mutations rejected)');
