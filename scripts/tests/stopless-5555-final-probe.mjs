...
//    output.summary 命中 'stopless budget exhausted' (third terminal);
...
try {
  ...
  record('step3.round3.terminal_after_three_hits', thirdCli.stdout?.summary === 'stopless budget exhausted' && thirdCli.stdout?.repeatCount === 3, {
