...
async function run503Scenario() {
  return withScenarioRuntime({ maxProviderAttempts: 3, responsesTimeoutMs: 15000 }, async (ctx) => {
    ...
    console.log('[debug health after first]', JSON.stringify(readRoutingGroupHealth(firstServer.routeCodex, 'gateway_priority_5555'), null, 2));
    ...
    console.log('[debug health after second]', JSON.stringify(readRoutingGroupHealth(firstServer.routeCodex, 'gateway_priority_5555'), null, 2));
    ...
    console.log('[debug runtimeHealthAfter503]', JSON.stringify(runtimeHealthAfter503, null, 2));
    console.log('[debug primaryRuntimeHealthAfter503]', JSON.stringify(primaryRuntimeHealthAfter503, null, 2));
