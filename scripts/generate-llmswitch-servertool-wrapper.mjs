...
export declare function validateServertoolHookSkeletonPhaseWithNative(input: unknown): unknown;export declare function planServertoolAutoHookQueueItemsWithNative(input: unknown): unknown;
`;
