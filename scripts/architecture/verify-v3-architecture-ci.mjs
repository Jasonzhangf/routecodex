...
const STEPS = [
  ...
  ['verify:v3-cargo-lock', 'V3 Cargo workspace passes the executable locked dependency gate'],
  ['test:v3-dependency-projection-red-fixtures', 'V3 dependency projection ownership mutations are rejected'],
