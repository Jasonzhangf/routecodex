...
const STEPS = [
  ...
  ['verify:v3-responses-continuation-disabled', 'Disabled Responses continuation cannot observe or commit direct remote continuation state'],
  ['test:v3-responses-continuation-disabled-red-fixtures', 'Disabled Responses continuation gate mutations are rejected'],
