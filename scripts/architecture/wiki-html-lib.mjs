    ...
    <section class="panel">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Config/restart</td><td><code>rccv3 config check -c /Volumes/extension/.rcc/config.toml</code>, then <code>rccv3 restart -c /Volumes/extension/.rcc/config.toml</code>. Legacy <code>routecodex restart --port</code> is not authoritative for this V3 instance.</td></tr>
