...
const dangerousPatterns = [
  ...
  /\bemitProviderError(?:AndWait)?\s*\(\s*\{/,
  /\brecoverable\s*:\s*(true|false)/,
  /\baffectsHealth\s*:\s*(true|false)/,
  /\berrorClassification\s*:\s*['"]/,
];
