...
if (!compatEngine.includes('feature_id: responses.instructions_to_input_normalization')) {
  failures.push('compat-engine missing instructions-to-input normalization feature anchor');
}
