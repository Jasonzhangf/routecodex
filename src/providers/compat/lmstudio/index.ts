...
CompatibilityModuleFactory.registerModuleType('lmstudio-compatibility', LMStudioCompatibility);
CompatibilityModuleFactory.registerModuleType('lmstudio', LMStudioCompatibility);
