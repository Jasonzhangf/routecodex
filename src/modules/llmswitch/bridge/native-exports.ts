...
function buildServertoolOutcomePlanInputNative(input: unknown): unknown {
  return invokeRouterHotpathJsonCapability('buildServertoolOutcomePlanInputJson', [input]);
}

function planServertoolOutcomeNative(input: unknown): unknown {
...
export function materializeNativeToolCallExecutionOutcomeWithNative(input: unknown): unknown {
  ...
  const outcomePlan = planServertoolOutcomeNative(
    buildServertoolOutcomePlanInputNative({
