...
export declare const MAX_STAGE_TRACE_ENTRIES = 40;
export declare const MAX_STAGE_TRACE_PAYLOAD_CHARS = 120000;
export declare const MAX_CLIENT_TOOL_ERROR_TRACE_ENTRIES = 6;
