...
export class ConfigCompatibility implements CompatibilityModule {
  ...
  async initialize(): Promise<void> {
    ...
    if (!pathToJson && this.cfg.providerAlias) {
      ...
      // dist 路径：dist/modules/pipeline/modules/compatibility/config/config-compatibility.js
      // 目标路径：dist/modules/pipeline/modules/compatibility/<providerAlias>/config/shape-filters.json
      try {
