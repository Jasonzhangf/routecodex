...
run('node --test cordis/routecodex-v4-cordis-host/tests/daemon-epoch.test.mjs cordis/routecodex-v4-cordis-host/tests/daemon.test.mjs cordis/routecodex-v4-cordis-host/tests/host-binding.test.mjs cordis/routecodex-v4-cordis-host/tests/host.test.mjs cordis/routecodex-v4-cordis-host/tests/host-typed-service-binding-red.test.mjs cordis/routecodex-v4-cordis-host/tests/m11-protocol-tools-admin-contract.test.mjs');
