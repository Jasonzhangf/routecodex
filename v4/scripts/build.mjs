...
run('cargo run --quiet --release --manifest-path Cargo.toml -p routecodex-v4-build-link -- build-consumer --root . --consumer routecodex-v4-runtime --deps routecodex-v4-base-node,routecodex-v4-control,routecodex-v4-error --source-deps routecodex-v4-cordis-bridge,routecodex-v4-node-container,routecodex-v4-plugin-contract,routecodex-v4-skeleton --out build-control/routecodex-v4-runtime/libroutecodex_v4_runtime.rlib');
