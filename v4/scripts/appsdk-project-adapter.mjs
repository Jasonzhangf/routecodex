...
writeEvidence(evidence('blackbox-1', 'deployed_blackbox', 'runtime', { adapter: 'project', identity: 'v4-cordis-blackbox' }, ['curl', '-fsS', 'http://127.0.0.1:5520/health'], 'deployed_blackbox'));
