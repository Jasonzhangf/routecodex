...
| M00-T07 | `feature_id:v4.cordis_m00.live_capture_binding` | 只绑定未来 live transport 的真实 provider-bound/raw evidence owner；无合法 owner/binding fail-closed；不实现 M08 runtime、不伪造 B 证据 | V4 provider contract + maps/gates/progress surfaces | M00-T06 | `in_progress` | `codex/v4-cordis-refactor-main` |
