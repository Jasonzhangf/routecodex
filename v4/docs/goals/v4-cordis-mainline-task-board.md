...
| M00-T07 | `feature_id:v4.cordis_m00.live_capture_binding` | 只绑定未来 live transport 的真实 provider-bound/raw evidence owner；不实现 M08 runtime、不伪造 B 证据 | V4 task contract/progress/evidence surfaces | M00-T06 | `available` | `codex/v4-cordis-refactor-main` |
