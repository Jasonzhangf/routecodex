...
selected V3 7777 configuration semantics into a deterministic, secret-free V4
manifest without making V4 runtime depend on V3.
...
2. Add a V3 7777 fixture importer that is explicit and read-only; no live V3
   config is read by V4 startup.
