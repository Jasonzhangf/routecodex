...
| M00-T07 live B capture binding contract | `available_after_T06` | T06 | M00 只绑定未来 live transport 的真实 provider-bound/raw evidence owner；不实现 M08 runtime、不伪造 B 证据；M08 完成后再做 live integration |
