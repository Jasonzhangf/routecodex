...
This audit is bound to the fresh `v4-cordis` governance candidate; re-running the feature-layer gate is required after any change to a guarded source or gate input.
