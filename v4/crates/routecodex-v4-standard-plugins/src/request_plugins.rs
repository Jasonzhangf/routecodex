...
pub(crate) fn descriptors() -> Vec<StandardPlugin> {
    vec![
        plugin("v4.std.request.responses_normalize", PluginCategory::Protocol, "V4HubReqInbound03Normalized", "request_inbound", Some(3), PluginKind::Validator, PluginEffect::ReadOnly, PluginPhase::Semantic, 100, vec!["v4.request.normal_payload"], vec![]),
        plugin("v4.std.request.chat_to_responses", PluginCategory::Protocol, "V4HubReqChatProcess04Governed", "request_chat_process", Some(4), PluginKind::Operator, PluginEffect::Semantic, PluginPhase::Projection, 200, vec!["v4.request.normal_payload"], vec!["v4.request.normal_payload"]),
        plugin("v4.std.request.governance", PluginCategory::ChatProcess, "V4HubReqChatProcess04Governed", "request_chat_process", Some(4), PluginKind::Operator, PluginEffect::Semantic, PluginPhase::Semantic, 300, vec!["v4.request.normal_payload"], vec!["v4.request.normal_payload"]),
        plugin("v4.std.request.provider_semantic", PluginCategory::Provider, "V4HubReqOutbound05ProviderSemantic", "request_outbound", Some(5), PluginKind::Operator, PluginEffect::Semantic, PluginPhase::Semantic, 100, vec!["v4.request.normal_payload"], vec!["v4.request.provider_semantic"]),
        plugin("v4.std.request.responses_wire_build", PluginCategory::Protocol, "V4ProviderReqCompat06Compat", "request_outbound", Some(6), PluginKind::Operator, PluginEffect::Semantic, PluginPhase::Projection, 100, vec!["v4.request.provider_semantic"], vec!["v4.request.provider_wire_payload"]),
    ]
}
