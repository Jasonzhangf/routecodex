...
interface ValidateFunction {
  ...
  (data: object | string, specName?: SpecName, options?: ValidationOptions): ValidationOutput;
}
...
//#endregion
export { ValidateFunction, ValidationOptions, ValidationOutput, validate };